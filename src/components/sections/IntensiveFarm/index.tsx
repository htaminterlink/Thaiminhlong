...
import AOS from "aos";
import IntensiveFarmGallery from "../IntensiveFarmGallery";
...
const IntensiveFarm: React.FC = () => {
  ...
  return (
    <>
      <SEO title="Trang Trại Thâm Canh" />

      {/* Banner Section */}
      <BannerSection>
        <BannerContent>
          <BannerTitle data-aos="fade-up">
            {t("farm.intensive.title", {
              defaultValue: "Trang Trại Thâm Canh",
            })}
          </BannerTitle>
          <BannerSubtitle data-aos="fade-up" data-aos-delay="200">
            {t("farm.intensive.subtitle", {
              defaultValue:
                "Công nghệ nuôi trồng tiên tiến cho hiệu suất và chất lượng tối đa",
            })}
          </BannerSubtitle>
      ...
      {/* Gallery Section */}
      <IntensiveFarmGallery />
    </>
  );
};

export default IntensiveFarm;
